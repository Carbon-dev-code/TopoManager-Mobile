...
const Physique: React.FC<PhysiqueProps> = ({ demandeur, setDemandeur, readonly = false }) => {
    return (
                    ...
                    <IonRow>
                            ...
                            {demandeur.neVers ? (
                                ...
                                <IonInput
                                    ...
                                    onIonChange={(e) =>
                                        setDemandeur({
                                            ...demandeur,
                                            dateNaissance: e.detail.value ? new Date(e.detail.value) : null,
                                        })
                                    }
                                />
                            )}
                        ...
                        <IonCol size="12">
                            <IonInput
                                ...
                                onIonChange={(e) =>
                                    setDemandeur({ ...demandeur, lieuNaissance: String(e.detail.value) })
                                }
                            />
                        </IonCol>
                        <IonCol size="12">
