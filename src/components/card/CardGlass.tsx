      ...
      <div className="glass-card-content">
          ...
          <div className="territoire-grid">
            {[
              ...
              },
              {
                label: "District",
                value:
                  currentParcelle.parametreTerritoire?.district.nomdistrict,
              },
              {
                label: "Commune",
              ...
              },
              {
                label: "Fokontany",
                value:
                  currentParcelle.parametreTerritoire?.fokontany.nomfokontany,
              },
              {
                label: "Hameau",
        ...
        <div className="section-card">
          <div className="section-header">
            ...
            <span className="section-badge">
              {currentParcelle.demandeurs.length}
            </span>
          </div>
        ...
        <div className="section-card">
          <div className="section-header">
            ...
            <span className="section-badge">
              {currentParcelle.riverin.length}
            </span>
          </div>
